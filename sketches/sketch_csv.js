...
var total_hombres = 0;
var total_mujeres = 0;
  for (var c = 0; a < data.getRowCount(); c++) {
   if (data.get(c, 5) == "male") {
      total_hombres++
   } else if (data.get(c, 5) == "females") {
      total_mujeres++
   }
}


   print("En el Titanic viajaban "+total_mujeres+" mujeres y murieron "+muerta+" mujeres");
   print("En el Titanic viajaban "+total_hombres+" mujeres y murieron "+muerto+" hombres");
